/**
 * Credits: https://github.com/Sunoo/homebridge-camera-ffmpeg
 * Borrowed form : https://github.com/Sunoo/homebridge-camera-ffmpeg/blob/master/src/streamingDelegate.ts
 */
import {
  API,
  APIEvent,
...
import { CameraConfig, VideoConfig } from '../types/DataModel.js';
...
export class StreamingDelegate implements CameraStreamingDelegate {
  ...
  async prepareStream(request: PrepareStreamRequest, callback: PrepareStreamCallback): Promise<void> {
    ...
    console.log(`VA - ${videoReturnPort}:${audioReturnPort}`);
