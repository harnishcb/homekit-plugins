...
exports.clampRgb = exports.hsvToColor = exports.rgbToHsv = exports.rgb2colorTemperature = exports.colorTemperature2rgb = exports.kelvinToMired = exports.miredToKelvin = void 0;
...
// from https://github.com/neilbartlett/color-temperature
function rgb2colorTemperature(rgb) {
    let temperature = 0, testRGB;
    const epsilon = 0.4;
...
function hsvToColor(h, s, wiz) {
    ...
    const h360 = h * 360;
    const s100 = s * 100;
    if ((h360 >= 0 && h360 <= 30 && s100 >= 0 && s100 <= 76) ||
        (h360 >= 220 && h360 <= 360 && s100 >= 0 && s100 <= 25)) {
        const possibleKelvin = rgb2colorTemperature(rgb);
        wiz.log.debug(`Considering possible Kelvin conversion of ${possibleKelvin}`);
        // check if bulb supports it
        if (possibleKelvin >= KELVIN_RANGE.min &&
