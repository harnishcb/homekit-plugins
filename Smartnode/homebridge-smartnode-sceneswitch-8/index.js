...
module.exports = (homebridge) => {
    ...
    homebridge.registerPlatform("homebridge-smartnode-sceneswitch-8", "Smartnode_Device-Scenepanel-8", sn);
}
...
class SNSCENEPANEL{
	...
	this.SNSCENEPANELX5 = new Service.StatelessProgrammableSwitch(this.name+"5",this.name+"5");
	this.SNSCENEPANELX6 = new Service.StatelessProgrammableSwitch(this.name+"6",this.name+"6");
    this.SNSCENEPANELX7 = new Service.StatelessProgrammableSwitch(this.name+"7",this.name+"7");
	this.SNSCENEPANELX8 = new Service.StatelessProgrammableSwitch(this.name+"8",this.name+"8");
	}
	...
	GetProgrammableSwitchEventX5(){
		return 0;
	 }
	 GetProgrammableSwitchEventX6(){
		return 0;
	 }
	 GetProgrammableSwitchEventX7(){
		return 0;
	 }
	 GetProgrammableSwitchEventX8(){
		return 0;
	 }
	getServices(){
	...
	this.SNSCENEPANELX5
		.getCharacteristic(Characteristic.ProgrammableSwitchEvent).onGet(this.GetProgrammableSwitchEventX5.bind(this))
		.setProps({ validValues: [0,2] });
	this.SNSCENEPANELX5
	   .getCharacteristic(Characteristic.ServiceLabelIndex).setValue(5);

	this.SNSCENEPANELX6
	   .getCharacteristic(Characteristic.ProgrammableSwitchEvent).onGet(this.GetProgrammableSwitchEventX6.bind(this))
	   .setProps({ validValues: [0,2] });
    this.SNSCENEPANELX6
	  .getCharacteristic(Characteristic.ServiceLabelIndex).setValue(6);

	  this.SNSCENEPANELX7
         .getCharacteristic(Characteristic.ProgrammableSwitchEvent).onGet(this.GetProgrammableSwitchEventX7.bind(this))
		 .setProps({ validValues: [0,2] });
	 this.SNSCENEPANELX7
	    .getCharacteristic(Characteristic.ServiceLabelIndex).setValue(7);

	 this.SNSCENEPANELX8
         .getCharacteristic(Characteristic.ProgrammableSwitchEvent).onGet(this.GetProgrammableSwitchEventX8.bind(this))
		 .setProps({ validValues: [0,2] });
	 this.SNSCENEPANELX8
	    .getCharacteristic(Characteristic.ServiceLabelIndex).setValue(8);

	 return [infoService,this.SNSCENEPANEL,this.SNSCENEPANELX2,this.SNSCENEPANELX3,this.SNSCENEPANELX4,this.SNSCENEPANELX5,this.SNSCENEPANELX6,this.SNSCENEPANELX7,this.SNSCENEPANELX8];
    }
	...
	updatevalue(node){
      ...
      break;
	  case 5:
	    this.SNSCENEPANELX5.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(0);
      break;
	  case 6:
	    this.SNSCENEPANELX6.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(0);
      break;
	  case 7:
	    this.SNSCENEPANELX7.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(0);
      break;
	  case 8:
	    this.SNSCENEPANELX8.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(0);
      break;
	  case 9:
      ...
      break;
	  case 13:
	    this.SNSCENEPANELX5.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(2);
      break;
	  case 14:
	    this.SNSCENEPANELX6.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(2);
      break;
	  case 15:
	    this.SNSCENEPANELX7.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(2);
      break;
	  case 16:
	    this.SNSCENEPANELX8.getCharacteristic(Characteristic.ProgrammableSwitchEvent).updateValue(2);
      break;
	}
}
}